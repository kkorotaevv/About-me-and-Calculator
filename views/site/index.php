            ...
            <div class="items-center justify-center flex flex-col">
              ...
              <div id="projectInfo" class="flex container items-end justify-between mt-10 mx-auto">
                <span class="text-gray-700 text-2xl lg:text-3xl">
                  Меня зовут <b>Кирилл</b> <br> Это мой первый проект, на стеке HTML, CSS, JS, PHP, SQL
                </span>
              </div>
            ...
            <div class="w-full border-l-2 px-4">
              <ul class="flex flex-col gap-12 px-8 relative">
                ...
                <li id="listItem2">
                  ...
                  <div>
                    <a href="https://t.me/kkorotaevv" target="_blank" class="font-semibold text-gray-700 text-xl">Telegram</a>
                    <p class="font-semibold text-gray-400 text-sm">Для личной связи</p>
                  </div>
                </li>
                ...
                <li id="listItem3">
                  ...
                  <div>
                    <a target="_blank" href="https://github.com/kkorotaevv" class="font-semibold text-gray-700 text-xl">GitHub</a>
                    <p class="font-semibold text-gray-400 text-sm">Личный GitHub</p>
                  </div>
                </li>
                ...
                <li id="listItem4">
                  ...
                  <div>
                    <a href="/site/calculator" target="_blank" class="font-semibold text-gray-700 text-xl">Калькулятор</a>
